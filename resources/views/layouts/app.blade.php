        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @else
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{ url('settings') }}"><i class="fa fa-btn fa-cog"></i>{{ trans('messages.settings') }}</a></li>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                            {{ trans('messages.lang') }} <span class="caret"></span>
                        </a>

                        <ul class="dropdown-menu" role="menu">
                            <li><a href="{{ url('language/es') }}">{{ trans('messages.es') }}</a></li>
                            <li><a href="{{ url('language/en') }}">{{ trans('messages.en') }}</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
